...
ABrackeysGameJam2021Character::ABrackeysGameJam2021Character()
{
...
void ABrackeysGameJam2021Character::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("TurnRate", this, &ABrackeysGameJam2021Character::TurnAtRate);
	PlayerInputComponent->BindAxis("LookUp", this, &APawn::AddControllerPitchInput);
	PlayerInputComponent->BindAxis("LookUpRate", this, &ABrackeysGameJam2021Character::LookUpAtRate);

	// handle touch devices
	PlayerInputComponent->BindTouch(IE_Pressed, this, &ABrackeysGameJam2021Character::TouchStarted);
	PlayerInputComponent->BindTouch(IE_Released, this, &ABrackeysGameJam2021Character::TouchStopped);
...
void ABrackeysGameJam2021Character::TouchStarted(ETouchIndex::Type FingerIndex, FVector Location)
{
		Jump();
}

void ABrackeysGameJam2021Character::TouchStopped(ETouchIndex::Type FingerIndex, FVector Location)
{
		StopJumping();
}

void ABrackeysGameJam2021Character::TurnAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerYawInput(Rate * BaseTurnRate * GetWorld()->GetDeltaSeconds());
}

void ABrackeysGameJam2021Character::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerPitchInput(Rate * BaseLookUpRate * GetWorld()->GetDeltaSeconds());
}

void ABrackeysGameJam2021Character::MoveForward(float Value)
{
...
void ABrackeysGameJam2021Character::MoveRight(float Value)
{
	if ( (Controller != NULL) && (Value != 0.0f) )
	{
